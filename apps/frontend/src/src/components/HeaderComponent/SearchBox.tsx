...
const SearchBox = () => {
  return (
    <div className="flex items-center justify-between flex-row  md:w-[340px] w-[150px] flex-1 cursor-pointer overflow-hidden rounded-xl  bg-[#202127] md:p-1 text-slate-400">
