...
const StatCard = ({ title }: stat) => {
  return (
    <Card className="hidden lg:block rounded-lg bg-[#14151B] text-white  text-base w-[380px] py-3 -mt-80 cursor-pointer z-50 border-none">
      <CardHeader>
        <CardTitle className="font-medium text-lg mb-1 ">{title}</CardTitle>
      </CardHeader>
